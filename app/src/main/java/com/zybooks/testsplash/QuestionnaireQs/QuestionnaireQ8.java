...
public class QuestionnaireQ8 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 8/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question8_20);

        // Override XML file with setting appropriate question (question 8)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q8);
        ...
        // Accesses the next question when button is clicked (question 9)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q8", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ7 when clicked
        ...
        backButton.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(view.getContext(), QuestionnaireQ7.class);
            view.getContext().startActivity(intent);
        });
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q8_explanation);
