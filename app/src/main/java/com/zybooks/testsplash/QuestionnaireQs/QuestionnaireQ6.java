...
public class QuestionnaireQ6 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 6/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question6_20);

        // Override XML file with setting appropriate question (question 6)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q6);
        ...
        // Accesses the next question when button is clicked (question 7)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q6", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ5 when clicked
        ...
        backButton.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(view.getContext(), QuestionnaireQ5.class);
            view.getContext().startActivity(intent);
        });
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q6_explanation);
