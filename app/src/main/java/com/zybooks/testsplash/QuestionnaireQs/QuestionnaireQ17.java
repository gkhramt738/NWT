...
public class QuestionnaireQ17 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 17/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question17_20);

        // Override XML file with setting appropriate question (question 17)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q17);
        ...
        // Accesses the next question when button is clicked (question 18)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q17", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ16 when clicked
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q17_explanation);
