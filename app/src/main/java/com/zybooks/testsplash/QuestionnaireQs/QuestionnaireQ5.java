...
public class QuestionnaireQ5 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 5/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question5_20);

        // Override XML file with setting appropriate question (question 5)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q5);
        ...
        // Accesses the next question when button is clicked (question 6)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q5", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ4 when clicked
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q5_explanation);
