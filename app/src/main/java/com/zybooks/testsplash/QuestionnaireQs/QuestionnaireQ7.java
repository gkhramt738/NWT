...
public class QuestionnaireQ7 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 7/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question7_20);

        // Override XML file with setting appropriate question (question 7)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q7);
        ...
        // Accesses the next question when button is clicked (question 8)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q7", userInputEditText.getText().toString());

            // Launches next question activity
            Intent intent = new Intent(view.getContext(), QuestionnaireQ8.class);
            view.getContext().startActivity(intent);
        });

        // Returns to QuestionnaireQ6 when clicked
        ...
        backButton.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(view.getContext(), QuestionnaireQ6.class);
            view.getContext().startActivity(intent);
        });
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q7_explanation);
