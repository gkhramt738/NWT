...
import com.zybooks.testsplash.Screens.LiabilitiesScreen;
...
public class QuestionnaireQ10 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 10/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question10_20);

        // Override XML file with setting appropriate question (question 10)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q10);
        ...
        // Accesses the liabilities section of the questionnaire (LiabilitiesScreen)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q10", userInputEditText.getText().toString());

            // Launches next question activity
            Intent intent = new Intent(view.getContext(), LiabilitiesScreen.class);
            view.getContext().startActivity(intent);
        });

        // Returns to QuestionnaireQ9 when clicked
        ...
        backButton.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(view.getContext(), QuestionnaireQ9.class);
            view.getContext().startActivity(intent);
        });
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q10_explanation);
