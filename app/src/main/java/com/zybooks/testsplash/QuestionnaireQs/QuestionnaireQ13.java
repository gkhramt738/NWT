...
public class QuestionnaireQ13 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 13/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question13_20);

        // Override XML file with setting appropriate question (question 13)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q13);
        ...
        // Accesses the next question when button is clicked (question 14)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q13", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ12 when clicked
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q13_explanation);
