...
public class QuestionnaireQ9 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 9/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question9_20);

        // Override XML file with setting appropriate question (question 9)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q9);
        ...
        // Accesses the next question when button is clicked (question 10)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q9", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ8 when clicked
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q9_explanation);
