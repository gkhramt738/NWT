...
public class QuestionnaireQ15 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 15/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question15_20);

        // Override XML file with setting appropriate question (question 15)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q15);
        ...
        // Accesses the next question when button is clicked (question 16)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q15", userInputEditText.getText().toString());

            // Launches next question activity
            Intent intent = new Intent(view.getContext(), QuestionnaireQ16.class);
            view.getContext().startActivity(intent);
        });

        // Returns to QuestionnaireQ14 when clicked
        ...
        backButton.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(view.getContext(), QuestionnaireQ14.class);
            view.getContext().startActivity(intent);
        });
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q15_explanation);
