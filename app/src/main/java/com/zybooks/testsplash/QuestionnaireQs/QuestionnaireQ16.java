...
public class QuestionnaireQ16 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 16/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question16_20);

        // Override XML file with setting appropriate question (question 16)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q16);
        ...
        // Accesses the next question when button is clicked (question 17)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q16", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ15 when clicked
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q16_explanation);
