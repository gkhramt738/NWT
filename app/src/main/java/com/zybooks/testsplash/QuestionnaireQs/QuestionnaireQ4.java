...
public class QuestionnaireQ4 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 4/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question4_20);

        // Override XML file with setting appropriate question (question 4)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q4);
        ...
        // Accesses the next question when button is clicked (question 5)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q4", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ3 when clicked
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q4_explanation);
