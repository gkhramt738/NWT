...
public class QuestionnaireQ12 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 12/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question12_20);

        // Override XML file with setting appropriate question (question 12)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q12);
        ...
        // Accesses the next question when button is clicked (question 13)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q12", userInputEditText.getText().toString());
        ...
        // Returns to QuestionnaireQ11 when clicked
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q12_explanation);
