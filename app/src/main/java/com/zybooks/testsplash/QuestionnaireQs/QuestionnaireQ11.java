...
public class QuestionnaireQ11 extends BaseQuestionnaire {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Override XML file with setting appropriate question count (question 11/X)
        TextView questionCount = findViewById(R.id.question_count);
        questionCount.setText(question11_20);

        // Override XML file with setting appropriate question (question 11)
        TextView questionText = findViewById(R.id.header);
        questionText.setText(q11);
        ...
        // Accesses the next question when button is clicked (question 12)
        ...
        nextQuestion.setOnClickListener(view -> {
            ...
            saveUserInput(KEY, "q11", userInputEditText.getText().toString());

            // Launches next question activity
            Intent intent = new Intent(view.getContext(), QuestionnaireQ12.class);
            view.getContext().startActivity(intent);
        });

        // Returns to LiabilitiesScreen when clicked
    ...
    public void onInfoIconClickShowPopupWindow(View view) {
        ...
        iconText.setText(R.string.q11_explanation);
